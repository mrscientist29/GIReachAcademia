...
function ThemeSettingsContent() {
  ...
  const [themeSettings, setThemeSettings] = useState<ThemeSettings>(themeStore.getTheme());
  ...
  const handleSaveTheme = async () => {
    setIsLoading(true);
    try {
      // Save theme to store and apply immediately
      themeStore.saveTheme(themeSettings);
      ...
      toast({
        ...
        description: "Your theme changes are now live across the entire website.",
      });
    } catch (error) {
      toast({
        title: "Error",
  ...
  const handlePreviewTheme = () => {
    ...
    themeStore.applyTheme(themeSettings);
    ...
    toast({
      ...
      description: "Theme preview is now active. Check the new tab to see changes.",
    });
  };
  ...
  const applyColorPreset = (preset: typeof colorPresets[0]) => {
    const newTheme = {
      ...
      // Enable dark mode if it's the dark mode preset
      darkMode: preset.name === "Dark Mode" ? true : themeSettings.darkMode
    };
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm font-medium flex items-center">
                ...
                Live Theme Editor - Changes apply instantly
              </div>
            </div>
                      ...
                      <div>
                        ...
                        >
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="1600px">Extra Large (1600px)</SelectItem>
                      ...
                      <div>
                        ...
                        >
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="24px">Rounded (24px)</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                      ...
                      <div>
                        ...
                        >
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="32px">Extra Spacious (32px)</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                        <div className="flex items-center space-x-2 mb-2">
                          ...
                          <span className="font-medium text-blue-800">Live Theme System</span>
                        </div>
                        <p className="text-sm text-blue-700">
                          Changes are applied instantly as you edit. Use "Save Theme" to make changes permanent across browser sessions.
                        </p>
                      </div>
                      ...
                      <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                        ...
                        <p className="text-sm text-yellow-700">
                          Advanced features like custom CSS, animations, and responsive breakpoints will be available in future updates.
                        </p>
                      </div>
                    </div>
                  </TabsContent>
              ...
              <CardContent className="p-6">
                ...
                <div className={`border border-gray-200 rounded-lg overflow-hidden ${
                  ...
                  <div 
                    ...
                    style={{
                      ...
                      fontWeight: themeSettings.typography.fontWeight
                    }}
                  >
                    <div 
                    ...
                    >
                      <h4 className="font-bold mb-2">Primary Section</h4>
                      <p className="text-sm opacity-90">This showcases your primary color and typography</p>
                    </div>
                    ...
                    >
                      <h4 className="font-semibold mb-2">Secondary Section</h4>
                      <p className="text-sm" style={{ color: themeSettings.colors.muted }}>
                        Secondary background with muted text color
                      </p>
                    </div>
                ...
                <div className="mt-4 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="space-y-1 text-sm text-gray-600">
                    <p><span className="font-medium">Font:</span> {themeSettings.typography.fontFamily}</p>
                    <p><span className="font-medium">Size:</span> {themeSettings.typography.fontSize}</p>
                    <p><span className="font-medium">Radius:</span> {themeSettings.layout.borderRadius}</p>
                    <p><span className="font-medium">Mode:</span> {themeSettings.darkMode ? 'Dark' : 'Light'}</p>
                  </div>
                </div>
...
export default function ThemeSettingsFunctional() {
  return (
